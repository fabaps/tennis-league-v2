...
const playerData = {
  ...
  pendingValidation: {
    opponent: "Oponente Ejemplo",
    score: "6-4, 7-5",
    date: "15 Nov 2023",
  },
  nextMatch: {
    opponent: "Próximo Oponente",
    opponentPic:
    ...
    date: "20 Nov 2023",
    time: "15:00",
    location: "Club de Tenis Ejemplo",
    whatsapp: "+50212345678",
  },
  tournaments: [
    { id: 1, name: "Torneo Ejemplo 1", date: "10 Ene 2023", result: "Semifinalista" },
    { id: 2, name: "Torneo Ejemplo 2", date: "5 Mar 2023", result: "Campeón" },
    { id: 3, name: "Torneo Ejemplo 3", date: "20 Jun 2023", result: "Cuartos de final" },
  ],
  matches: [
    {
      id: 1,
...
export default function ProfileContent({ router }: ProfileContentProps) {
  ...
  // En una aplicación real, aquí se cargarían los datos del jugador basados en el playerId
  ...
  return (
    <>
      <div className="text-center mb-8">
        ...
        {playerId && <p className="text-gray-600">ID del jugador: {playerId}</p>}
      </div>
        ...
        <section className="mb-8">
          <Card className="bg-white shadow-md rounded-xl overflow-hidden">
            <CardHeader className="bg-yellow-100">
              <CardTitle className="text-xl font-semibold text-yellow-700">Validación de Marcador Pendiente</CardTitle>
            </CardHeader>
            <CardContent className="p-6">
              ...
              <div className="mt-4 flex justify-end space-x-4">
                <Button onClick={() => handleValidation(true)} className="bg-green-500 hover:bg-green-600 text-white">
        ...
        <Card className="bg-white shadow-md rounded-xl overflow-hidden">
          <CardContent className="p-6 flex items-center justify-between">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600">en su Categoría</p>
            </div>
